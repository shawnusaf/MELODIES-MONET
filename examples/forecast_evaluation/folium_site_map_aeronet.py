...
#end_date="2022-08-25"
#todays_date="20220825"

#have to change the AOD variable name
if species == 'AOD_550':
    species = 'aod_550nm'
...
for i in range(len(site_name)):
    ...
    plot_name="plot_" + plot_type + "." + species + "." + start_date + "_00." + end_date + "_00.siteid." + site_name[i]
    ...
    image.save(fp = path + plot_name + "_resize.png") #save back to the original plot directory
